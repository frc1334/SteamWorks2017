...
import org.usfirst.frc.team1374.robot.commands.ClimbCommand;
import org.usfirst.frc.team1374.robot.commands.DriveCommand;
import org.usfirst.frc.team1374.robot.commands.IntakeCommand;
...
public class Robot extends IterativeRobot
{
    ...
    public void robotInit()
    {
        ...
        Robot = NetworkTable.getTable("Pitable");
    }
    ...
    public void teleopPeriodic()
    {
    	...
    	FOV = Robot.getNumber("width", 1);
    	x = Robot.getNumber("X", FOV/2);
    	x2 =Robot.getNumber("X2", FOV/2);
